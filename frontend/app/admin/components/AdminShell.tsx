...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex bg-gray-100 overflow-hidden">
      ...
      >
        {/* Logo */}
        <div className="flex flex-col items-center text-[#C8A96A] mt-6">
        ...
        {/* USER */}
        <div className="m-3 p-2 rounded-xl bg-gray-100">
          <div className="flex items-center gap-3">
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 py-1.5 rounded-lg text-xs font-medium text-gray-500 hover:bg-red-50 hover:text-red-600 border transition"
          >
            <LogOut size={14} />
            Đăng xuất
          </button>
